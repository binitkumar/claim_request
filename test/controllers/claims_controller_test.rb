...
class ClaimsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create claim" do
    assert_difference('Claim.count') do
      post claims_url, params: { claim: { terms_and_conditions: @claim.terms_and_conditions, user_id: @claim.user_id } }
    end
  ...
  test "should update claim" do
    patch claim_url(@claim), params: { claim: { terms_and_conditions: @claim.terms_and_conditions, user_id: @claim.user_id } }
